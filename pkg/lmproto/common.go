...
func (f Framer) String() string {
	return fmt.Sprintf("packetType: %s remainingLength:%d NoPersist:%v redDot:%v syncOnce:%v DUP:%v", f.PacketType.String(), f.RemainingLength, f.NoPersist, f.RedDot, f.SyncOnce, f.DUP)
}
